function [ImgBoxResampQuntz3D,levels,MorphROI,IntsBoxROI,ImgWholeResmp,ROIwholeResmp,newpixelW,newsliceTh] = prepareVolume(volume,Mask,DataType,pixelW,sliceTh,R,newVoxelSize,VoxInterp,ROIInterp,ROI_PV,scaleType,isIsot2D,isScale,isGLrounding,DiscType,QuantAlg,Ng,isReSegRng,ResegIntrval,isOutliers,isclcGlobPeak)
% -------------------------------------------------------------------------
