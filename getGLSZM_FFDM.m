function [GLSZM] = getGLSZM_FFDM(ROIOnly,levels)
% -------------------------------------------------------------------------
...
% INITIALIZATION
nInit = numel(ROIOnly);%the size of GLSZM is too big, out of memory for DBT,but it's ok for FFDM
%nInit = 1900000;%decrease the size, revised by wenbing Lv,just for DBT
