function [SUVmax,SUVpeak,SUVmean,SUVstd,SUVvar,SUVenergy,aucCSH] = getSUVmetrics(ROIonlyPET)
% -------------------------------------------------------------------------
...
%SUVstd
SUVstd = std(ROIonlyPET(~isnan(ROIonlyPET)));

% SUVvar 
SUVvar = (SUVstd)^2;

%SUVenergy
SUVenergy = sum(ROIonlyPET(~isnan(ROIonlyPET)).^2);
